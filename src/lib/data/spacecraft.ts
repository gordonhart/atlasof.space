...
export const GALILEO = spacecraftWithDefaults({
  ...
  orbitalRegimes: [OrbitalRegimeId.JUPITER_SYSTEM, OrbitalRegimeId.ASTEROID_BELT, OrbitalRegimeId.OUTER_SYSTEM],
  status: {
    status: SpacecraftStatus.DECOMMISSIONED,
...
export const EUROPA_CLIPPER = spacecraftWithDefaults({
  ...
  focusId: Bodies.JUPITER.id,
  orbitalRegimes: [OrbitalRegimeId.JUPITER_SYSTEM, OrbitalRegimeId.INNER_SYSTEM, OrbitalRegimeId.OUTER_SYSTEM],
  status: { status: SpacecraftStatus.OPERATIONAL },
...
export const CHANGE_2 = spacecraftWithDefaults({
  ...
  orbitalRegimes: [OrbitalRegimeId.EARTH_SYSTEM, OrbitalRegimeId.INNER_SYSTEM],
