...
export const MERCURY = celestialBodyWithDefaults({
  ...
  name: 'Mercury',
  influencedBy: [SOL.id],
  orbitalRegime: asOrbitalRegimeId(HeliocentricOrbitalRegime.INNER_SYSTEM),
  elements: {
    wrt: SOL.id,
    epoch: J2000,
...
export const CERES = celestialBodyWithDefaults({
  ...
  shortName: 'Ceres',
  influencedBy: [SOL.id],
  orbitalRegime: asOrbitalRegimeId(HeliocentricOrbitalRegime.ASTEROID_BELT),
  elements: {
    wrt: SOL.id,
...
export const EROS = celestialBodyWithDefaults({
  ...
  shortName: 'Eros',
  influencedBy: [SOL.id],
  orbitalRegime: asOrbitalRegimeId(HeliocentricOrbitalRegime.INNER_SYSTEM), // NEA
  elements: {
    wrt: SOL.id,
    epoch: J2000, // TODO: verify
    eccentricity: 0.2226,
...
export const PLUTO = celestialBodyWithDefaults({
  ...
  influencedBy: [SOL.id],
  orbitalRegime: asOrbitalRegimeId(HeliocentricOrbitalRegime.KUIPER_BELT),
  elements: {
    wrt: SOL.id,
    epoch: J2000,
    eccentricity: 0.2488,
...
export const SEDNA = celestialBodyWithDefaults({
  ...
  shortName: 'Sedna',
  influencedBy: [SOL.id],
  orbitalRegime: asOrbitalRegimeId(HeliocentricOrbitalRegime.INNER_OORT_CLOUD),
  elements: {
    wrt: SOL.id,
...
export const JUPITER = celestialBodyWithDefaults({
  ...
  name: 'Jupiter',
  influencedBy: [SOL.id],
  orbitalRegime: asOrbitalRegimeId(HeliocentricOrbitalRegime.OUTER_SYSTEM),
  elements: {
    wrt: SOL.id,
    epoch: J2000,
    eccentricity: 0.0489,
